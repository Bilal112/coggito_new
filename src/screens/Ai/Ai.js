    ...
    return (
        <div className='container-fluid p-0' id='ai-page' >
            <div className='ai-service-page-background' >
                <ReactTypingEffect
                    text="ARTIFICIAL INTELLIGENCE" //text=["Hello.", "World!"]
            ...
            <div className='container' >
                <div className='row' >
                    <div className='col-sm col-md-6' >
                        <div className='p-2' >
                            <img src='https://data-economy.com/wp-content/uploads/2018/07/shutterstock_465653942-682x395.jpg' className='img img-fluid ai-img-1' />
                        </div>
                    </div>
                    <div className='col-sm col-md-6' >
                        <div className='p-3' >
                            <h4>What’s Artificial Intelligence?</h4>
                ...
                <div className='row' >
                    ...
                    <div className='col-sm col-md-6' >
                        <div className='p-2' >
                            ...
                            <img src='http://galaxytecno.tk/wp-content/uploads/2018/10/Inteligencia-Artificial.jpg' className='img img-fluid ai-img-1' />
                        </div>
                    </div>
                </div>
            </div>
