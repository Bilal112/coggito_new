...
const Dl = () => {
    return (
        <div className='container-fluid p-0' id='dl-page' >
            <div className='dl-service-page-background' >
            <ReactTypingEffect
                    text="DEEP LEARNING" //text=["Hello.", "World!"]
            ...
            <div className='container' >
                <div className='row' >
                    <div className='col-sm col-md-6' >
                        <div className='p-2' >
                            <img src='http://freedomandsafety.com/sites/default/files/artificial-intelligence-neural-networks.jpg' className='img img-fluid dl-img-1' />
                        </div>
                    </div>
                    <div className='col-sm col-md-6' >
                        <div className='p-3' >
                            <h4>What’s Deep Learning</h4>
            ...
            <div className='container' >
                <div className='row' >
                    <div className='col-sm col-md-6' >
                        ...
                        <div className='p-3' >
                            <h4>The Future of Deep Learning</h4>
                            <p className='text-justify' >
                    ...
                    <div className='col-sm col-md-6' >
                        <div className='p-2' >
                            ...
                            <img src='https://miro.medium.com/max/2000/1*lThcpUr8rVhatShptucVHg.jpeg' className='img img-fluid ai-img-1' />
                        </div>
                    </div>
                </div>
            </div>
